...
public class Jeopardy implements ActionListener {
	...
	public void run() {
		...
		JPanel panel = createHeader("randomtopicname");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (buttonPressed == firstButton) {
			...
			askQuestion("At which continent is Brazil located", "South America", 200);
		...
		if (buttonPressed == secondButton) {
			...
			askQuestion("What is the largest country in the world, in terms of geographic area?", "Russia", 400);
			// Clear the text on the button that was pressed (set the button text to
			// nothing)
			secondButton.setText("");
		}
		if (buttonPressed == thirdButton) {
			askQuestion("How many degrees are in a n-gon?", "180(n-2)", 600);
			thirdButton.setText("");
		}
		if (buttonPressed == fourthButton) {
			askQuestion("What is the capital of Australia?", "Sydney", 800);
			fourthButton.setText("");
		}
		if (buttonPressed == fifthButton) {
			askQuestion("Solubility is determined by the similarity between two substances' what?",
